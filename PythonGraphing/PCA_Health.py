...
pca = PCA(n_components=5) #n_components=2
...
df["pca_4"] = pca_result[:, 3]
df["pca_5"] = pca_result[:, 4]


centroids = df.drop(columns=["point_id", "cost", "pca_1", "pca_2", "pca_3", "pca_4", "pca_5"]).groupby("cluster_id").mean()
